 ...
 * limitations under the License.
 */
class O{constructor(e){this.container=e}getPlatformInfoString(){const e=this.container.getProviders();return e.map(e=>{if(R(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null}).filter(e=>e).join(" ")}}function R(e){const t=e.getComponent();return"VERSION"===(null===t||void 0===t?void 0:t.type)}const N="@firebase/app",x="0.10.13",D=new i.Vy("@firebase/app"),P="@firebase/app-compat",L="@firebase/analytics-compat",M="@firebase/analytics",F="@firebase/app-check-compat",U="@firebase/app-check",V="@firebase/auth",j="@firebase/auth-compat",B="@firebase/database",$="@firebase/data-connect",q="@firebase/database-compat",G="@firebase/functions",K="@firebase/functions-compat",z="@firebase/installations",H="@firebase/installations-compat",W="@firebase/messaging",Q="@firebase/messaging-compat",X="@firebase/performance",J="@firebase/performance-compat",Y="@firebase/remote-config",Z="@firebase/remote-config-compat",ee="@firebase/storage",te="@firebase/storage-compat",ne="@firebase/firestore",re="@firebase/vertexai-preview",ie="@firebase/firestore-compat",se="firebase",oe="10.14.1",ae="[DEFAULT]",ce={[N]:"fire-core",[P]:"fire-core-compat",[M]:"fire-analytics",[L]:"fire-analytics-compat",[U]:"fire-app-check",[F]:"fire-app-check-compat",[V]:"fire-auth",[j]:"fire-auth-compat",[B]:"fire-rtdb",[$]:"fire-data-connect",[q]:"fire-rtdb-compat",[G]:"fire-fn",[K]:"fire-fn-compat",[z]:"fire-iid",[H]:"fire-iid-compat",[W]:"fire-fcm",[Q]:"fire-fcm-compat",[X]:"fire-perf",[J]:"fire-perf-compat",[Y]:"fire-rc",[Z]:"fire-rc-compat",[ee]:"fire-gcs",[te]:"fire-gcs-compat",[ne]:"fire-fst",[ie]:"fire-fst-compat",[re]:"fire-vertex","fire-js":"fire-js",[se]:"fire-js-all"},ue=new Map,le=new Map,he=new Map;function de(e,t){try{e.container.addComponent(t)}catch(n){D.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function fe(e){const t=e.name;if(he.has(t))return D.debug(`There were multiple attempts to register component ${t}.`),!1;he.set(t,e);for(const n of ue.values())de(n,e);for(const n of le.values())de(n,e);return!0}function pe(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function ge(e){return void 0!==e.settings}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Go{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new Go(this.firestore,e,this._query)}}class Ko{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new zo(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Ko(this.firestore,e,this._key)}}class zo extends Go{constructor(e,t,n){super(e,t,Mt(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Ko(this.firestore,null,new ee(e))}withConverter(e){return new zo(this.firestore,e,this._path)}}function Ho(e,t,...n){if(e=(0,c.Ku)(e),Po("collection","path",t),e instanceof $o){const r=J.fromString(t,...n);return Fo(r),new zo(e,null,r)}{if(!(e instanceof Ko||e instanceof zo))throw new P(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(J.fromString(t,...n));return Fo(r),new zo(e.firestore,null,r)}}function Wo(e,t,...n){if(e=(0,c.Ku)(e),1===arguments.length&&(t=K.newId()),Po("doc","path",t),e instanceof $o){const r=J.fromString(t,...n);return Mo(r),new Ko(e,null,new ee(r))}{if(!(e instanceof Ko||e instanceof zo))throw new P(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(J.fromString(t,...n));return Mo(r),new Ko(e.firestore,e instanceof zo?e.converter:null,new ee(r))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function ec(e){e=Vo(e,Ko);const t=Vo(e.firestore,Jo);return Ro(Zo(t),e._key).then(n=>cc(t,e,n))}class tc extends Ha{constructor(e){super(),this.firestore=e}convertBytes(e){return new ta(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Ko(this.firestore,null,t)}}function nc(e){e=Vo(e,Go);const t=Vo(e.firestore,Jo),n=Zo(t),r=new tc(t);return Ra(e._query),No(n,e._query).then(n=>new Ya(t,r,e,n))}function rc(e,t,n){e=Vo(e,Ko);const r=Vo(e.firestore,Jo),i=Wa(e.converter,t,n);return ac(r,[fa(da(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,On.none())])}function ic(e,t,n,...r){e=Vo(e,Ko);const i=Vo(e.firestore,Jo),s=da(i);let o;return o="string"==typeof(t=(0,c.Ku)(t))||t instanceof na?ma(s,"updateDoc",e._key,t,n,r):ga(s,"updateDoc",e._key,t),ac(i,[o.toMutation(e._key,On.exists(!0))])}function sc(e){return ac(Vo(e.firestore,Jo),[new $n(e._key,On.none())])}function oc(e,...t){var n,r,i;e=(0,c.Ku)(e);let s={includeMetadataChanges:!1,source:"default"},o=0;"object"!=typeof t[o]||Xo(t[o])||(s=t[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(Xo(t[o])){const e=t[o];t[o]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[o+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[o+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let u,l,h;if(e instanceof Ko)l=Vo(e.firestore,Jo),h=Mt(e._key.path),u={next:n=>{t[o]&&t[o](cc(l,e,n))},error:t[o+1],complete:t[o+2]};else{const n=Vo(e,Go);l=Vo(n.firestore,Jo),h=n._query;const r=new tc(l);u={next:e=>{t[o]&&t[o](new Ya(l,r,n,e))},error:t[o+1],complete:t[o+2]},Ra(e._query)}return function(e,t,n,r){const i=new Eo(r),s=new $s(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>Ls(await Oo(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>Ms(await Oo(e),s))}}(Zo(l),h,a,u)}function ac(e,t){return function(e,t){const n=new L;return e.asyncQueue.enqueueAndForget(async()=>to(await ko(e),t,n)),n.promise}(Zo(e),t)}function cc(e,t,n){const r=n.docs.get(t._key),i=new tc(e);return new Xa(e,i,t._key,r,new Qa(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
